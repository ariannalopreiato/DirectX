...
{
	LoadEffectVariable();
	BuildInputLayout(pDevice);
}

void FlatEffect::BuildInputLayout(ID3D11Device* pDevice)
{
...
void FlatEffect::LoadEffectVariable()
{
	//Techniques
...
// COMPLETE EFFECT
CompleteEffect::CompleteEffect(ID3D11Device* pDevice, const std::wstring& assetFile)
	:Effect(pDevice, assetFile)
{
	LoadEffectVariable();
	BuildInputLayout(pDevice);
...
void CompleteEffect::BuildInputLayout(ID3D11Device* pDevice)
{
	//create vertex layout
...
void CompleteEffect::LoadEffectVariable()
{
	//Techniques
	m_pPointTechnique = m_pEffect->GetTechniqueByName("PointTechnique");
	if (!m_pPointTechnique->IsValid())
